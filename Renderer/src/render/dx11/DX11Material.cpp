...
//RenderMaterialType::RenderMaterialType(MaterialArchetypeDesc const& desc)
//{
//
...
//}
//
//void RenderMaterialType::Bind(rnd::RenderContext& rctx, EShadingLayer layer, EMatType matType)
//{
