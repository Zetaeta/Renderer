...
//DEFINE_BASIC_TYPEINFO(int);
//DEFINE_BASIC_TYPEINFO(u32);
//DEFINE_BASIC_TYPEINFO(u64);
//DEFINE_BASIC_TYPEINFO(s64);
//DEFINE_BASIC_TYPEINFO(float);
//DEFINE_BASIC_TYPEINFO(double);
//DEFINE_BASIC_TYPEINFO(u8);
//DEFINE_BASIC_TYPEINFO(s8);
//DEFINE_BASIC_TYPEINFO(u16);
//DEFINE_BASIC_TYPEINFO(s16);
//DEFINE_BASIC_TYPEINFO(bool);
