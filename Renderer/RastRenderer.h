...
public:
	...
	void DrawTri(mat4 const& fullTrans, std::array<ClipSpaceVertex, 3> const& verts, MaterialID mat);

	float ComputeLighting(const vec3& normal , const vec3& rayDir, int specularity);
